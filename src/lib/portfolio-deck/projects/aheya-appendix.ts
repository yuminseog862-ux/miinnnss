...
export const aheyaAppendixSlides = [
  {
    ...
    accent: "violet",
    variant: "matrix",
    intent: "Trust API를 Core Rail 본문과 분리된 내부/runtime API boundary evidence로 정리한다.",
    claim: "Trust API는 public GTM 성과가 아니라 evaluation, signal, trust memory를 다룬 내부 API/runtime layer",
    include: ["Core Rail", "Trust API", "Signal memory", "Boundary"],
    slots: ["public product headline 아님", "resolve -> signals -> trust memory", "Core Rail semantics reuse", "external demand proof 제외"],
    table: {
      headers: ["Area", "Core Rail", "Trust API"],
      rows: [
  ...
  },
  {
    ...
    accent: "cyan",
    variant: "matrix",
    intent: "ETH/SOL onchain material을 Core Rail의 proof substrate로만 보여준다.",
    claim: "wallet action을 support/proof로 바꾸는 verification substrate, not adoption proof",
    include: ["Core Rail", "EVM/Base", "Solana", "Boundary"],
  ...
  },
  {
    ...
    accent: "amber",
    variant: "matrix",
    intent: "Raven/Aheaya legacy planning을 현재 Core Rail과 분리된 기획/문서화 evidence로 정리한다.",
