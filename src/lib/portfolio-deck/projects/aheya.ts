...
export const aheyaSlides = [
  ...
  },
  {
    ...
    claim: "AHEYA는 남는 온체인 자산을 small support action으로, 불명확한 관심을 Good/Improve feedback과 saved record로 바꿔 초기 AI service idea의 첫 반응을 기록 가능한 단위로 만든다",
  ...
  },
  {
    ...
    claim: "Builder가 원본 X 글을 anchor로 삼아 후원, 상세 피드백, saved record를 다음 업데이트 판단 재료로 확인하는 first-signal 구조",
  ...
  },
  {
    ...
    claim: "Measurement design, not performance result. crypto trading information sharing에서 AI builder service idea로 전환한 판단 근거와 제품 반영",
  ...
  },
  {
    ...
    claim: "Builder-first GTM은 기능 설명보다 문제 인지를 먼저 도달시키고, visual hook을 public discovery entry로 배치해 donation/feedback 행동까지 이어지게 설계했다",
  ...
  },
  {
    ...
    table: {
      ...
      rows: [
        ...
        ["GTM", "Outcome first", "builder outcome messaging으로 전환"],
