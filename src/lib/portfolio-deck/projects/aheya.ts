...
export const aheyaSlides = [
  ...
  },
  {
    ...
    table: {
      ...
      rows: [
        ["2025-12~01", "Smart contract / Solana deploy plan", ""],
        ["2026-02", "Support box + Good/Improve UX", ""],
        ["2026-02~03", "Mainnet-ready support chain + Privy", ""],
        ["2026-03~04", "Offchain receipt publish path", ""],
        ["2026-04", "Direct-send verify + feedback decouple", ""],
      ],
    },
  },
  {
    ...
    table: {
      ...
      rows: [
        [
          "잔여 온체인 자산 리서치",
          "에어드랍·퀘스트·거래 이후 지갑에 남는 native gas token / project token 흐름을 보며, 작은 온체인 자산이 gas·chain·용도 장벽 때문에 실제 효용으로 이어지기 어렵다는 점을 확인",
        ...
        [
          ...
          "AI로 demo, docs, GitHub, launch post를 만드는 속도는 빨라졌지만, 공개 이후 X marketing 글만으로는 첫 반응·명확한 피드백·업데이트 근거가 약하게 남는다는 점을 확인",
  ...
  },
  {
    ...
    slots: [
      ...
      "Boundary: KPI outcome, 성과·수요 입증 아님",
    ],
  ...
  },
  {
    ...
    table: {
      ...
      rows: [
        ...
        ["Boundary", "current deck에서는 성과 숫자, 수요 입증, 지표 개선을 결론으로 쓰지 않음", "29번은 방향 판단과 다음 측정 구조로만 연결"],
      ],
    },
  },
  {
