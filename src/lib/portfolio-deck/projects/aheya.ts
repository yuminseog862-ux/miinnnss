...
export const aheyaSlides = [
  ...
  },
  {
    no: 19.6,
    section: "AHEYA",
    title: "KPI Verification Map",
    label: "KPI / Runtime 19-6",
    accent: "cyan",
    variant: "matrix",
    custom: "aheyaKpiBoard",
    intent: "사용자 행동 KPI와 운영 snapshot을 분리해 검증 항목과 후속 확인 조건을 한 장에서 정리한다.",
    claim: "사용자 행동 5단계와 운영 snapshot을 분리해, 무엇을 검증하고 언제 재확인할지 정리",
    include: ["User action KPI tree", "Operational snapshot", "Read-only comparison", "Alert rule", "Boundary"],
    process: [
      "Awareness | X post view · profile click · site visit",
      "Interest | landing scroll · CTA click · project open",
      "Understanding | support explainer read · Good/Improve",
      "Intent | support start · proof submit · manual reply",
      "Quality | approved proof · implemented feedback · repeat action",
    ],
    table: {
      headers: ["Verification area", "Signals / state", "Question", "Follow-up"],
      rows: [
        ["Funding", "pending · confirmed · verified · 24h stale", "후원 처리 흐름이 멈추지 않는가?", "stale → 재확인"],
        ["Review queue", "feedback proof · creator review · submitted idea", "검토 대기열이 누적되는가?", "≥20 / ≥10 → follow-up"],
        ["Activity / freshness", "active login · dashboard snapshot stale", "활동 신호와 데이터가 최신인가?", "0 / stale → 확인"],
        ["Connectors / trust", "connector error · stale sync · trust signal queue", "운영 연결·신뢰 상태가 정상인가?", "error / ≥20 → check"],
        ["Snapshot compare", "latest snapshot · history", "변화·이상·원인·다음 액션을 비교하는가?", "read-only compare"],
      ],
    },
    slots: [
      "사용자 행동: 무엇이 발견·이해·행동으로 이어지는가",
      "운영: 상태·대기열·신선도·연결을 기준으로 재확인",
      "전체 scope: funding · review queues · trust ops · connectors · points · governance · health",
      "threshold는 성과가 아니라 follow-up trigger",
      "실제 전환·매출·성장 성과를 주장하지 않음",
    ],
  },
  {
    no: 20,
