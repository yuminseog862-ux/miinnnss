  ...
  coverCases: [
    {
      ...
      label: "Flagship Case",
      body: "AI service idea를 행동 경로, 메시지, 측정 단위로 좁힌 first-signal planning case",
    },
    {
      title: "ADSB",
