...
export const workCases: WorkCase[] = [
  ...
  },
  {
    ...
    roles: ["Hook & motif planning", "Prompt & motion direction", "Image-to-video iteration"],
    ...
    galleryIntro:
      "The short-form video leads this case, followed by dog-and-ball stills and Kling proof that show the image-to-video direction behind it.",
    placeholderMedia: [
      {
