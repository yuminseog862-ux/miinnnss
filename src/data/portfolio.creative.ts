...
export const workCases: WorkCase[] = [
  ...
  },
  {
    ...
    galleryIntro:
      "This page is strongest when the flagship AHEYA surfaces sit next to Greek and Egyptian public experiments: together they show how persona, symbolic hierarchy, and recall shift across different identity roles.",
    placeholderMedia: [
      {
        label: "Primary persona surface",
        note: "A supporting persona-facing visual used to widen the system beyond the flagship entry character.",
        src: "/aheya/creator.png",
        alt: "AHEYA supporting persona visual.",
      },
      {
      ...
      {
        label: "Hephaestus",
        note: "Maker-facing Greek variation used to test a heavier forged-material identity and role-coded recall.",
        src: "/appendix/bluegarage/hephaestus_vid.MP4",
        alt: "Hephaestus persona experiment.",
        type: "video",
        displaySize: "compact",
      ...
      {
        label: "Ares",
        note: "Aggression-coded Greek variation used to see how harder motion and sharper energy affect first read.",
        src: "/appendix/bluegarage/ares_vid.MP4",
        alt: "Ares persona experiment.",
        type: "video",
        displaySize: "compact",
      ...
      {
        label: "Athena",
        note: "Strategy-coded Greek variation used to test a calmer, more controlled symbolic role.",
        src: "/appendix/bluegarage/athena_vid.MP4",
        alt: "Athena persona experiment.",
        type: "video",
        displaySize: "compact",
        href: "https://x.com/minnns_aheya/status/2042939083438329914?s=46",
        hrefLabel: "Open Athena post",
        stat: "2w video view",
      },
      {
        label: "Glass study",
        note: "A material-driven public experiment that sits next to the deity-coded set as a motif and texture study.",
        src: "/appendix/bluegarage/glass_vid.MP4",
        alt: "Glass public experiment.",
        type: "video",
        displaySize: "compact",
      ...
      {
        label: "Anubis",
        note: "Egyptian variation used to test a threshold-guardian role and a darker symbolic register.",
        src: "/appendix/bluegarage/anubis_vid.MP4",
        alt: "Anubis persona experiment.",
        type: "video",
        displaySize: "compact",
      },
      {
        label: "Horus",
        note: "Egyptian variation used to test a clearer watchful identity and higher symbolic legibility.",
        src: "/appendix/bluegarage/horus_img.PNG",
        alt: "Horus persona image.",
      },
      {
        label: "Ra",
        note: "Egyptian solar variation used to test brighter authority and symbolic heat inside the persona system.",
        src: "/appendix/bluegarage/ra_vid.MP4",
        alt: "Ra persona experiment.",
        type: "video",
        displaySize: "compact",
      },
    ],
